...
\begin{algorithm}
    ...
    \State $i\gets i+m$
    \EndWhile
    \State \textbf{return} $\boldsymbol{b}$\Comment{b is the array containing all the Medians we want}
    \EndProcedure
    \end{algorithmic}
\end{algorithm}\\
...
\begin{algorithm}
    ...
    \State $x\gets MedianofMedians(\boldsymbol{b},m,\frac{m}{2n})$\Comment{Find the median of array $\boldsymbol{b}$}
